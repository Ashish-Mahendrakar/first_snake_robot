...
: ${AMENT_CURRENT_PREFIX:="/home/ashish/s3_ws/install/s3_controller"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/s3_controller/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/s3_controller/environment/path.sh"
